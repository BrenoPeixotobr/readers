...
urlpatterns = [
    ...
    path('lista/<str:nome>', views.lista_livbib, name='lista_livbib'),
    ...
    path('lista_livros_biblioteca_leitor/<str:nome>', views.lista_livros_biblioteca_leitor, name='lista_livros_biblioteca_leitor'),
    path('lista_livro_leitor/<str:livro>', views.lista_livro_leitor, name='lista_livro_leitor'),
